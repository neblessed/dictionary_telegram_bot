...
- Если пользователь отвечает не правильно, то бот писылает сообщение "Не правильный ответ"
...
#### После прохождения тестирования пользователю предалагается статистика:
- Количество слов в экзамене
- Правильных ответов
